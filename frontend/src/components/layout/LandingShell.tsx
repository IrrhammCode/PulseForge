    ...
    <div className="min-h-screen">
      <header className="sticky top-0 z-50 border-b border-border bg-background/90 backdrop-blur-xl">
        <div className="mx-auto flex h-16 max-w-6xl items-center justify-between gap-4 px-4 sm:px-6 lg:px-8">
          <Link href="/welcome" className="flex items-center gap-3 transition hover:opacity-90">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            <span className="hidden rounded-full border border-border bg-surface-elevated px-3 py-1 text-[10px] font-medium text-muted md:inline-block">
              Musicathon 2026
            </span>
